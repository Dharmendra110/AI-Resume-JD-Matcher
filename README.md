...
2. Open a branch, implement changes, and submit a pull request.

## License

This project does not include a license file. Add one (for example MIT) if you intend to make the project public.
...
- wire up a build script that outputs a Chrome-ready folder
